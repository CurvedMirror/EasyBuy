...
<div class="log_bg">	
    <div class="top">
        <div class="logo"><a href="index.jsp"><img src="${ctx}/statics/images/logo.png" /></a></div>
    </div>
	<div class="regist">
		...
		<div class="reg_c">
            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="50">
                ...
                <td><input type="text" value="" name="userName"class="l_pwd" /></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="text" value=""name="identityCode" class="l_pwd" /></td>
              </tr>
              <tr height="50">
...
<script type="text/javascript" src="${ctx}/statics/js/common/jquery-1.11.1.min_044d0927.js"></script>
	...
	<script type="text/javascript" src="${ctx}/statics/js/pre/register/register.js"></script>
