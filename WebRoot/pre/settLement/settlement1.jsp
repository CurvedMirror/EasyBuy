            ...
            <tr>
                ...
                <td align="center">
                    <div class="c_num">
                        ...
                        <input type="text" value="${temp.quantity}" name="" class="car_ipt" onchange="changeQuantity(this,'${temp.product.id}','${temp.product.stock}')"/>
        ...
        <tr valign="top" height="150">
            <td colspan="6" align="right">
                ...
                <c:if test="${sessionScope.cart!=null && sessionScope.cart.sum>0}">
               	    <a href="javascrpt:;" onclick="settlement2();"><img src="${ctx}/statics/images/buy2.gif" /></a>
                </c:if>
            </td>
        </tr>
    </table>
