            ...
            <div class="list_c">
                <ul class="cate_list">
                    <c:forEach items="${pList}" var="pList">
                        <li>
                            <div class="img">
                                <a href="${ctx}/Product?action=queryProductDeatil&id=${pList.id}" target="_blank">
                            ...
                            <div class="name"><a href="${ctx}/Product?action=queryProductDeatil&id=${pList.id}">${pList.name}</a></div>
                            <div class="carbg">
