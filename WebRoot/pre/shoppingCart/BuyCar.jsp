		...
		<div class="content mar_20">
			<table border="0" class="car_tab"
				...
				<tr>
					<td>
						<div class="c_s_img">
							<img src="${ctx}/statics/images/c_1.jpg" width="73" height="73" />
						</div> Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml</td>
				...
				<tr class="car_tr">
					<td>
						<div class="c_s_img">
							<img src="${ctx}/statics/images/c_2.jpg" width="73" height="73" />
						</div> Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml</td>
					<td align="center">颜色：灰色</td>
					<td align="center">
						<div class="c_num">
					...
					<td align="center" style="color:#ff4e00;">￥620.00</td>
					<td align="center">26R</td>
					<td align="center"><a href="#">删除</a>&nbsp; &nbsp;<a href="#">加入收藏</a>
					</td>
				</tr>
				<tr>
					<td>
						<div class="c_s_img">
							<img src="${ctx}/statics/images/c_3.jpg" width="73" height="73" />
						</div> Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml</td>
					<td align="center">颜色：灰色</td>
					<td align="center">
						<div class="c_num">
				...
				<tr class="car_tr">
					<td>
						<div class="c_s_img">
							<img src="${ctx}/statics/images/c_4.jpg" width="73" height="73" />
						</div> Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml</td>
					<td align="center">颜色：灰色</td>
					<td align="center">
						<div class="c_num">
				...
				<tr height="70">
					<td colspan="6"
						...
						class="r_rad"><input type="checkbox" name="clear"
							checked="checked" />
					</label><label class="r_txt">清空购物车</label> <span class="fr">商品总价：<b
							style="font-size:22px; color:#ff4e00;">￥2899</b>
					</span></td>
				</tr>
				<tr valign="top" height="150">
					<td colspan="6" align="right"><a href="#"><img
							src="${ctx}/statics/images/buy1.gif" />
					</a>&nbsp; &nbsp; <a href="#"><img
							src="${ctx}/statics/images/buy2.gif" />
					</a></td>
				</tr>
			</table>
			...
			<div class="white_d">
				<div class="notice_t">
					<span class="fr" style="margin-top:10px; cursor:pointer;"
						...
						src="${ctx}/statics/images/close.gif" />
					</span>
				</div>
				<div class="notice_c">
