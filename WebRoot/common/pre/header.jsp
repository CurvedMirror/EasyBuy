		...
		<div class="sou">
			...
			<span class="fr"> 
				...
				<c:if test="${sessionScope.loginUser==null}">
					<span class="fl">你好，请<a href="${ctx}/login?action=toLogin">登录</a>&nbsp; <a href="${ctx}/pre/register.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;</span>
				</c:if>
				...
				<c:if test="${sessionScope.loginUser!=null}">
					<c:if test="${sessionScope.loginUser.type==1}">
						...
						<span class="fl">|&nbsp; <a href="${ctx}/news?action=queryNewsList" style="color:#ff4e00;">后台管理&nbsp;</a></span>
