   ...
   <div class="b_btm_bg b_btm_c">
			<div class="b_btm">
				<table border="0"
					...
					<tr>
						<td width="72"><img src="${ctx}/statics/images/b1.png"
				...
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="${ctx}/statics/images/b2.png"
							width="62" height="62" /></td>
				...
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="${ctx}/statics/images/b3.png"
							width="62" height="62" /></td>
				...
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="${ctx}/statics/images/b4.png"
							width="62" height="62" /></td>
		...
		<div class="b_nav">
			...
			<div class="b_er">
				<div class="b_er_c">
					<img src="${ctx}/statics/images/er.gif" width="118" height="118" />
				</div>
