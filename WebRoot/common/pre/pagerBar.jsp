...
<!--         也就是 当起始页大于2的时候 左边显示两个页码，当结束页能腾出两个页码的位置时候显示两个页码 -->
        <c:forEach  var="temp" begin="${pager.currentPage>2?pager.currentPage-2:1}" end="${pager.pageCount-pager.currentPage>2?pager.currentPage+2:pager.pageCount}" step="1">
