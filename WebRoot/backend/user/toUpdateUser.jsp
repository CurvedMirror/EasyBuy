...
<head>
    ...
    <script src="${ctx}/statics/js/backend/user/user.js"></script>
</head>
...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        ...
        <div class="m_right" id="content">
            ...
            <br>
            <form action="javascript:;" method="post" id="userAdd" >
                <table border="0" class="add_tab" style="width:930px;" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="135" align="right" id="username">用户姓名</td>
                        <td colspan="3" style="font-family:'宋体';">
                            <input type="text" value="${user.loginName}"  onblur=" return checkName(value)" class="add_ipt" name="loginName"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${empty user.id || user.id==0}">
                                    <input type="button" value="添加用户" class="s_btn" name="isAdd" onclick="updateUser('添加用户')">
                                </c:when>
                                <c:otherwise>
                                    <input type="button" value="修改信息" class="s_btn" name="isAdd" onclick="updateUser('修改信息')">
                                </c:otherwise>
                            </c:choose>
                        </td>
                    </tr>
