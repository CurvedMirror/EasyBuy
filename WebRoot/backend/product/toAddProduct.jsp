...
<div class="i_bg bg_color">
            ...
            <table border="0" class="add_tab" style="width:930px;" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <img id="img" style="<c:if test="${product.fileName==null || product.fileName==''}">display:none</c:if>"src="${ctx}/files/${product.fileName}" width="50" height="50"/>
    ...
    <script src="${ctx}/statics/js/backend/product/product.js"></script>
    <script src="${ctx}/statics/js/backend/productCategory/productCategory.js"></script>
</div>
</body>
</html>
